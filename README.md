...
### 2. Data Import
- Loaded CSV using TablePlus's import feature.
...
- Displayed on a pie chart the percentage of items that are out of stock

- Displayed on different bar graphs category wise-> A. Total items that are in stock, B. Weight of items, C. Total Value of those items
